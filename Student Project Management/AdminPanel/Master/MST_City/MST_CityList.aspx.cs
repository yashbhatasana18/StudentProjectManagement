...
public partial class AdminPanel_Master_MST_City_MST_CityList : System.Web.UI.Page
{
    ...
    {
        MST_CityBAL balMST_City = new MST_CityBAL();
        rptCityList.DataSource = balMST_City.SelectAll(LoginType); ;
    ...
    private void Search(int PageNo)
    {
        ...
        DataTable dt = balMST_City.SelectPage(Offset, PageRecordSize, out TotalRecords, CityName);
    ...
    private void ClearControls()
    {
        ...
        CommonFunctions.BindEmptyRepeater(rptCityList);
        Div_SearchResult.Visible = false;
    }
