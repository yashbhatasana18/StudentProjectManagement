...
public partial class AdminPanel_Master_MST_AcademicYear_MST_AcademicYearList : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("~/AdminPanel/Master/MST_AcademicYear/MST_AcademicYearAddEdit.aspx");
    }
    #endregion New Button Event

    #region Function - Delete Department
    protected void rptAcademicYearList_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "DeleteRecord" && e.CommandArgument != null)
        {
            try
            {
                ...
                balMST_AcademicYear.Delete(Convert.ToInt32(e.CommandArgument));
            }
            catch (Exception ex)
            {
                lblErrorMsg.Text = ex.Message;
    ...
    {
        MST_AcademicYearBAL balMST_AcademicYear = new MST_AcademicYearBAL();
        rptAcademicYearList.DataSource = balMST_AcademicYear.SelectAll(LoginType, InstituteID); ;
        rptAcademicYearList.DataBind();
        int Count = rptAcademicYearList.Items.Count;
    ...
    private void Search(int PageNo)
    {
        ...
        SqlString AcademicYearName = SqlString.Null;
        ...
        if (txtAcademicYear.Text.Trim() != String.Empty)
            AcademicYearName = txtAcademicYear.Text.Trim();

        #endregion Gather Data

        MST_AcademicYearBAL balMST_AcademicYear = new MST_AcademicYearBAL();

        DataTable dt = balMST_AcademicYear.SelectPage(Offset, PageRecordSize, out TotalRecords, AcademicYearName);
        ...
        if (dt != null && dt.Rows.Count > 0)
        {
            ...
            rptAcademicYearList.DataSource = dt;
            rptAcademicYearList.DataBind();
        ...
        else
        {
            ...
            rptAcademicYearList.DataSource = null;
            rptAcademicYearList.DataBind();
    ...
    private void ClearControls()
    {
        ...
        CommonFunctions.BindEmptyRepeater(rptAcademicYearList);
        Div_SearchResult.Visible = false;
    }
