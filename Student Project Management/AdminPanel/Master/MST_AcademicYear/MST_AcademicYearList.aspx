<%@ Page Title="AcademicYear List | Student Project Management" EnableTheming="true" Theme="Admin" Language="C#" MasterPageFile="~/AdminPanel/AdminMaster.master" AutoEventWireup="true" CodeFile="MST_AcademicYearList.aspx.cs" Inherits="AdminPanel_Master_MST_AcademicYear_MST_AcademicYearList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="cphPageHeader" runat="Server">
    AcademicYear <small>(<asp:Label ID="lblCount" runat="server" Text="Academic Year Count"></asp:Label>)</small>
</asp:Content>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <asp:TextBox ID="txtAcademicYear" CssClass="First form-control" runat="server" PlaceHolder="Enter Academic Year"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light" style="padding: 10px 20px 0px 10px; margin-bottom: 0px">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <asp:HyperLink ID="hlAdd" runat="server" NavigateUrl="~/AdminPanel/Master/MST_AcademicYear/MST_AcademicYearAddEdit.aspx"
                                    CssClass="btn btn-success" Text="<i class='fa fa-plus-circle'></i>&nbsp;Add Academic Year"> 
                                </asp:HyperLink>
                            </div>
                        </div>
                            ...
                            <div class="row" runat="server" id="Div_SearchResult" visible="false">
                                <div class="col-md-12">
                                    <div id="TableContent" style="overflow-x: auto;">
                                        <table class="table table-responsive table-bordered table-striped table-hover" id="tbAcademicYear">
                                            <thead>
                                                <tr class="TRDark">
                                                    <th hidden>
                                                        <asp:Label ID="lbhAcademicYearID" runat="server" Text="AcademicYear ID"></asp:Label>
                                                    </th>
                                                    <th class="text-center">
                                                        <asp:Label ID="lbhAcademicYearName" runat="server" Text="AcademicYear Name"></asp:Label>
                                                    </th>
                                                    <th class="text-center">
                                                        <asp:Label ID="lbhFromDate" runat="server" Text="FromDate"></asp:Label>
                                                    </th>
                                                    <th class="text-center">
                                                        <asp:Label ID="lbhToDate" runat="server" Text="ToDate"></asp:Label>
                                                    </th>
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="rptAcademicYearList" runat="server" OnItemCommand="rptAcademicYearList_ItemCommand">
                                                    <ItemTemplate>
                                                        <tr>
                                                            <td hidden><%#Eval("AcademicYearID") %></td>
                                                            ...
                                                            <td class="tdaction text-nowrap text-center">
                                                                <asp:HyperLink ID="hlEdit" SkinID="Edit" runat="server" NavigateUrl='<%# String.Concat("MST_AcademicYearAddEdit.aspx?","academicyearid=",Eval("AcademicYearID")) %>'>
                                                                </asp:HyperLink>

                                                                <asp:HyperLink ID="hlView" SkinID="View" runat="server" NavigateUrl='<%# String.Concat("MST_AcademicYearView.aspx?","academicyearid=",Eval("AcademicYearID")) %>'>
                                                                </asp:HyperLink>

                                                                <asp:HyperLink ID="hlCopy" SkinID="Copy" runat="server" NavigateUrl='<%# String.Concat("MST_AcademicYearAddEdit.aspx?","academicyearid=",Eval("AcademicYearID"),"&Copy=Y") %>'>
                                                                </asp:HyperLink>

                                                                <asp:LinkButton ID="hlDelete" SkinID="Delete" runat="server" CommandArgument='<%#Eval("AcademicYearID") %>'
